...
## What this is not (read carefully)

Root-Ascent Method is a **socio-technical causal analysis protocol** (incident → structure → levers).

It is **not**:

- a numerical optimizer, gradient method, or energy-landscape algorithm;  
- a license to invent “+X% real-world impact” from a desk run;  
- a replacement for primary sources or domain expertise.

If you find yourself minimizing Rastrigin functions or maximizing k_cat under this name, **stop** — you have left the method. Reload [PROMPT.md](PROMPT.md).
...
> Work strictly according to Root-Ascent Method v0.4 (Causal Ladder) — socio-technical analysis, NOT a numerical optimizer. Declare case-specific intent. Saturation checks. Rivals before Level 4. No invented field-impact percentages. Levers + operational strategy. Stay disciplined.
...
| [EXAMPLES.md](EXAMPLES.md) | Prior runs (do not reuse as your case) |
| [INTENT.md](INTENT.md) | Intent layers |
| [WORKING-PAPER.md](WORKING-PAPER.md) | Rationale, limits |
...
1. Prefer the prompt (v0.4).  
2. Respect the ladder; saturation before ascent.  
3. Counter-hypotheses before Level-4 lock — **and revise L4 when rivals win**.  
4. Calibrate against **declared** intent.  
5. Stay grounded to the concrete start.  
...
Help intelligence climb from noise and symptoms to structural causes — and climb back down to things that can actually be changed.

---

*Root-Ascent Method / Causal Ladder*  
Maintained by IrsanAI
